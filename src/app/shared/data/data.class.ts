...
export class Data {
    ...
    //     new FoodItem('Salami', 10, ['Mozzarella', 'Tomaten', 'Salami'], 7.00, ),
    //     new FoodItem('Schinken', 20, ['Mozzarella', 'Tomaten', 'Schinken'], 7.50, ),
    //      new FoodItem('4 Käse', 30, ['Mozzarella', 'Tomaten', 'Parmesan', 'Schmelzkäse', 'Feta', 'Mozzarella', 'Tomaten', 'Parmesan', 'Schmelzkäse', 'Feta',
    //     'Mozzarella', 'Tomaten', 'Parmesan', 'Parmesan', 'Schmelzkäse', 'Feta'], 10.00 ),
    // ];

    // static Salad: FoodItem[] = [
    //     new FoodItem('Vorspeisensalat', 100, ['Salat', 'Soße'], 3.00, ),
    //     new FoodItem('Cäsar Salat', 110, ['Salat', 'Cäsardressing', 'Hähnchen', 'Croutons'], 7.00, ),
    //     new FoodItem('Tomatensalat', 120, ['Tomaten', 'Mozzarella'], 9.00),
    // ]
